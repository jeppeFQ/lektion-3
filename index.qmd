...
I det funktionsorienterede paradigme behandles opgaven, der skal løses, som en evaluering af matematiske funktioner. Eksempler på funktionelle programmeringssprog er Scheme, Erlang, OCaml, Haskell, SML, Lisp og F#.
...
# Brug af higher-order funktioner
balances = [1000, 2000, 3000]
with_interest = list(map(lambda x: add_interest(x, 0.05), balances))
...
print("Oprindelige beløb:", balances)
print("Med 5% rente:", with_interest)
print("10 års rentes rente:", calculate_compound_interest(1000, 0.05, 10))
